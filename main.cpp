...
void repaint2() {
  tft.fillScreen(TFT_BLACK);
  int i = 0;  
  for (int x = 40; x < 320; x += 140 ) {
    for (int y = 45; y < 480 ; y += 145) {
      tft.drawRect(x,y,100,100,TFT_WHITE);
    }
  }
}
